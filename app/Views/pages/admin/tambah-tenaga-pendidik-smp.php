...
<div class="main__content px-4 pt40">
    <div class="d-flex align-items-baseline mb10">
        <a href="<?= base_url('admin/dataSmp'); ?>" class="text-decoration-none blue">Data Menengah Pertama</a>
        <h4 class="mx-2">/</h4>
        <a href="<?= base_url('admin/detailSmp/' . $npsn); ?>" class="text-decoration-none blue">Detail Sekolah</a>
        <h4 class="mx-2">/</h4>
    ...
    <div class="detail__header d-flex justify-content-between align-items-center">
        ...
        <a href="<?= base_url('admin/detailSmp/' . $npsn); ?>">
    ...
    <?php endif; ?>
    <div class="mt20">
        <form action="/admin/simpanTenagaPendidikSmp" method="POST" class="needs-validation" novalidate>
            <div class="row">
