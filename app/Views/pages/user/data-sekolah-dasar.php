              ...
              <?php foreach ($dataSekolah as $dataSekolah) : ?>
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn__aksi">
                      <a href="<?= base_url() ?>/user/detailSekolahDasar/<?= $dataSekolah['npsn'] ?> " data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat detail" class="bgblue text-white text-decoration-none px-3 py-1">
                        Detail
                      </a>
                    </div>
                  </td>
